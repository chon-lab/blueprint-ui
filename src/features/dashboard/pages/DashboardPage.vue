...
<template>
  <div class="flex h-full min-h-0 flex-col overflow-hidden" :aria-busy="isLoading">
    ...
    <div class="mt-[clamp(0.75rem,4vh,2.5rem)] grid min-h-0 flex-1 gap-5 2xl:grid-cols-[minmax(0,1fr)_minmax(22rem,36%)]">
      <section class="flex min-h-0 min-w-0 flex-col">
        <h2 class="mb-2 shrink-0 text-base font-normal text-foreground">Indicadores</h2>
        <div
          ref="indicatorsGridRef"
          data-testid="indicators-grid"
          class="grid min-h-0 flex-[1.05] gap-2.5 overflow-hidden"
        ...
        <div
          ...
          class="grid min-h-0 flex-1 gap-2.5 overflow-hidden"
      ...
      <section class="hidden min-h-0 min-w-0 flex-col 2xl:flex">
        <h2 class="mb-2 shrink-0 text-base font-normal text-foreground">Distribui&ccedil;&atilde;o das a&ccedil;&otilde;es pelo territ&oacute;rio</h2>
        <div
          class="min-h-0 flex-1 rounded-lg border border-border bg-[linear-gradient(145deg,var(--bp-color-neutral-0),var(--bp-color-neutral-50))]"
